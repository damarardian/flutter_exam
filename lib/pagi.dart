        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  // Text("Membaca surat Al Falaq", textAlign: TextAlign.center,),
                  Text("اَللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا، وَبِكَ نَحْيَا، وَبِكَ نَمُوْتُ وَإِلَيْكَ النُّشُوْرُ", style: TextStyle(fontSize: 20), textAlign: TextAlign.center,),
                  SizedBox(height: 20,),
                  Text("“Ya Allah, dengan rahmat dan pertolongan-Mu kami memasuki waktu pagi, dan dengan rahmat dan pertolongan-Mu kami memasuki waktu petang. Dengan rahmat dan pertolongan-Mu kami hidup dan dengan kehendak-Mu kami mati. Dan kepada-Mu kebangkitan (bagi semua makhluk).”", style: TextStyle(fontSize: 15), textAlign: TextAlign.center,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  // Text("Membaca surat Al Falaq", textAlign: TextAlign.center,),
                  Text("أَصْبَحْنَا عَلَى فِطْرَةِ اْلإِسْلاَمِ وَعَلَى كَلِمَةِ اْلإِخْلاَصِ، وَعَلَى دِيْنِ نَبِيِّنَا مُحَمَّدٍ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ، وَعَلَى مِلَّةِ أَبِيْنَا إِبْرَاهِيْمَ، حَنِيْفًا مُسْلِمًا وَمَا كَانَ مِنَ الْمُشْرِكِيْنَ", style: TextStyle(fontSize: 20), textAlign: TextAlign.center,),
                  SizedBox(height: 20,),
                  Text("“Di waktu pagi kami memegang agama Islam, kalimat ikhlas (kalimat syahadat), agama Nabi kami Muhammad shallallahu ‘alaihi wa sallam, dan agama bapak kami Ibrahim, yang berdiri di atas jalan yang lurus, muslim dan tidak tergolong orang-orang musyrik.”", style: TextStyle(fontSize: 15), textAlign: TextAlign.center,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text("Dibaca 1x", textAlign: TextAlign.justify,),
                  SizedBox(height: 20,),
                  Text("Membaca Sayyidul Istigfar\n", textAlign: TextAlign.justify,),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text("“Ya Allah, sesungguhnya aku memohon kebajikan dan keselamatan di dunia dan akhirat. Ya Allah, sesungguhnya aku memohon kebajikan dan keselamatan dalam agama, dunia, keluarga dan hartaku. Ya Allah, tutupilah auratku (aib dan sesuatu yang tidak layak dilihat orang) dan tenteramkanlah aku dari rasa takut. Ya Allah, peliharalah aku dari muka, belakang, kanan, kiri dan atasku. Aku berlindung dengan kebesaran-Mu, agar aku tidak disambar dari bawahku (oleh ular atau tenggelam dalam bumi dan lain-lain yang membuat aku jatuh).”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text("“Dengan nama Allah yang bila disebut, segala sesuatu di bumi dan langit tidak akan berbahaya, Dia-lah Yang Maha Mendengar lagi Maha Mengetahui.”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text("“Aku ridha Allah sebagai Rabb, Islam sebagai agama dan Muhammad shallallahu ‘alaihi wa sallam sebagai nabi.”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text("“Wahai Rabb Yang Maha Hidup, wahai Rabb Yang Berdiri Sendiri (tidak butuh segala sesuatu), dengan rahmat-Mu aku minta pertolongan, perbaikilah segala urusanku dan jangan diserahkan kepadaku sekali pun sekejap mata (tanpa mendapat pertolongan dariMu).”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text("“Tidak ada ilah yang berhak disembah selain Allah semata, tidak ada sekutu bagiNya. Bagi-Nya kerajaan dan segala pujian. Dia-lah yang berkuasa atas segala sesuatu.”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text("Dibaca 3x pada waktu pagi", textAlign: TextAlign.center,),
                  SizedBox(height: 20,),
                  // Text("Membaca surat Al Falaq", textAlign: TextAlign.center,),
                  Text("سُبْحَانَ اللهِ وَبِحَمْدِهِ: عَدَدَ خَلْقِهِ، وَرِضَا نَفْسِهِ، وَزِنَةَ عَرْشِهِ وَمِدَادَ كَلِمَاتِهِ", style: TextStyle(fontSize: 20), textAlign: TextAlign.center,),
                  SizedBox(height: 20,),
                  Text("“Maha Suci Allah, aku memujiNya sebanyak makhluk-Nya, sejauh kerelaan-Nya, seberat timbangan ‘Arsy-Nya dan sebanyak tinta tulisan kalimat-Nya.”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  // Text("Membaca surat Al Falaq", textAlign: TextAlign.center,),
                  Text("اَللَّهُمَّ إِنِّيْ أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلاً مُتَقَبَّلاً", style: TextStyle(fontSize: 20), textAlign: TextAlign.center,),
                  SizedBox(height: 20,),
                  Text("“Ya Allah, sungguh aku memohon kepada-Mu ilmu yang bermanfaat (bagi diriku dan orang lain), rizki yang halal dan amal yang diterima (di sisi-Mu dan mendapatkan ganjaran yang baik).”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text("“Maha suci Allah, aku memuji-Nya.”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  // Text("Membaca surat Al Falaq", textAlign: TextAlign.center,),
                  Text("أَسْتَغْفِرُ اللهَ وَأَتُوْبُ إِلَيْهِ", style: TextStyle(fontSize: 20), textAlign: TextAlign.center,),
                  SizedBox(height: 20,),
                  Text("“Aku memohon ampun kepada Allah dan bertobat kepada-Nya.”", style: TextStyle(fontSize: 15), textAlign: TextAlign.justify,),
                ],
              ),
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15.0),
